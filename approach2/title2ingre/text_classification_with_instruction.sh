...
export WANDB_NAME="deberta_instruction_origin" #! need change each run
...
$python_exec "$script_path" \
    ...
    --text_column_names "title,instructions" \
    ...
    --do_eval "True" \
    --do_predict "True" \
    --output_dir "/local/xiaowang/food_ingredient/saved_models/approach2/text_classification_instruction" \
